...
impl<F: Field, EF: ExtensionField<F>> Constraint<F, EF> {
    ...
    /// # Returns
    ///
    /// An iterator over `(&MultilinearPoint<EF>, EF)` pairs.
...
mod tests {
    ...
    fn test_constraint_new_eq_only() {
        ...
        let eq_point_0 = MultilinearPoint::new(vec![EF::from_u64(1), EF::from_u64(2)]);
        let eq_eval_0 = EF::from_u64(10);
    ...
    fn test_constraint_combine_evals() {
        ...
        let eq_point_0 = MultilinearPoint::new(vec![EF::from_u64(1), EF::from_u64(1)]);
